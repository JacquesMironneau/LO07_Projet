...
<div class="container">
    ...
    <div>
        <h3 class="h3">Il fait actuellement <strong><span id="degree"></span> degrés</strong> dehors à <span id="ville"></span> !</h3>
        <span class="h5">Nous vous conseillons d'aller vous faire vacciner en: </span>
        <img id="habit" src="" height="200" width="200">
    </div>
</div>
    <script>
    ...
    <em><p>Données récupérées depuis OpenWheatherApi</p></em>
